...
<script type="text/javascript">
	...
	function showClueRemarkList(){
		...
		$.ajax({
			url:"workbench/clue/getAllClueRemark.do",
			data:{
				"clueId": id
			},
			type:"get",
			...
			success:function (data) {
				...
				$.each(data,function (i,n) {
					...
					html+= '<font color="gray">线索</font> <font color="gray">-</font> <b>'+"${clue.fullname}-"+"${clue.appellation}"+'</b> <small style="color: gray;"> '+n.createTime+' 由'+n.editBy+'</small>';

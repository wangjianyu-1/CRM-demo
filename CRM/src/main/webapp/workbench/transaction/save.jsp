...
<body>
	...
	<form class="form-horizontal" id="tranForm" action="workbench/transaction/save.do" method="post" role="form" style="position: relative; top: -30px;">
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				...
				<input type="hidden"  value="5181b899b41d4a9da425debb8ac0ff8a" name="activityId">
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				...
				<input type="hidden" value="6822007257d44653938c4041761cba44" name="customerId" >
			</div>
		</div>

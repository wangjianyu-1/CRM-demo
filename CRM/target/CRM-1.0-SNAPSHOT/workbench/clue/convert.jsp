...
<script type="text/javascript">
	$(function(){
		...
		//为放大镜图标绑定事件
		$("#openSourceSearchBtn").click(function () {
		...
		//为搜索框绑定回车进行搜索
		$("#search-aName").keydown(function (e) {
			if(e.keyCode == 13){
				getActivityListByName();
				return false;
			}
...
<body>
		...
		<div class="modal-dialog" role="document" style="width: 90%;">
			<div class="modal-content">
				...
				<div class="modal-body">
					<div class="btn-group" style="position: relative; top: 18%; left: 8px;">
						<form class="form-inline" role="form">
						  <div class="form-group has-feedback">
						    <input type="text" id="search-aName" class="form-control" style="width: 300px;" placeholder="请输入市场活动名称，支持模糊查询">
					...
					<button  id="submitActivityBtn" type="button" class="btn btn-primary">保存</button>
				</div>
	...
	<div id="create-transaction2" style="position: relative; left: 40px; top: 20px; width: 80%; background-color: #F7F7F7; display: none;" >
		...
		<form id="tranForm" action="workbench/clue/convert.do" method="post">
		  ...
		  <div class="form-group" style="width: 400px;position: relative; left: 20px;">
		    <label for="activity">市场活动源&nbsp;&nbsp;<a href="javascript:void(0);" data-toggle="modal"  style="text-decoration: none;"><span class="glyphicon glyphicon-search" id="openSourceSearchBtn"></span></a></label>
